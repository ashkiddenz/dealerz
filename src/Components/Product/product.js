const Product = ({item}) => {
    return (
        <div className="card col-md-4 col-12 mx-2 mb-3" style={{height:'640',width:420}}>
            <img className="card-img-top p-5" src={item.image} style={{height:400,width:400}} alt={item.title} />
